...
const accentClassMap = {
  ...
  amber:     { border: 'border-terminal-accent-primary/40', title: 'text-terminal-accent-primary', glow: 'shadow-[0_0_24px_rgb(var(--color-accent-primary)/0.1),inset_0_0_16px_rgba(0,0,0,0.5)]' },
};
