...
export default function CRTWrapper({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative w-full overflow-hidden bg-terminal-bg-base">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-0 right-0 z-40 h-[15vh] bg-gradient-to-b from-transparent via-terminal-bg-base/30 to-transparent mix-blend-multiply animate-scanline-beam"
      />
