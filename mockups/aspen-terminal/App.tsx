...
export default function App() {
  ...
  return <div className="tm-preview">
    ...
    <Shell page={route.page} viewKey={route.page === 'entry' ? `entry:${route.entryMode}:${entryRun}` : route.page} lang={lang} t={t} setLang={setLang} crt={crt} toggleCrt={() => setCrt(value => !value)}>
      ...
      <div hidden={route.page !== 'transmit'} data-active={route.page === 'transmit'}><Transmit t={t} failSubmission={failSubmission} samples={samples} /></div>
