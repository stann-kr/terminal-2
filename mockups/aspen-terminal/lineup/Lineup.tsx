...
export function Lineup(props: ScreenProps & { artistId: string | null }) {
  ...
  useReadoutMotion(profileRef, { key: `${event?.id}:${artistId}:${lang}`, titles: '#tm-artist-name', content: '.tm-profile-top .tm-eyebrow,.tm-artist-data > div,.tm-artist-bio > p,#tm-artist-profile > p' });
